...
void HT1635B::begin(byte i2caddr) {
  i2caddr_ = i2caddr;
  Wire.begin();
...
void HT1635B::setRowMemory(byte index, byte data) {
  row_[index] |= data;
}

void HT1635B::clearRowMemory(byte index, byte data) {
  row_[index] &= ~(data);
}
...
void HT1635B::setBrightness(byte brightness) {
  /**
...
void HT1635B::setBlinking(byte speed) {
  /**
...
void HT1635B::setCOM(byte option) {
  /**
...
void HT1635B::setSystemMode(byte mode) {
  /**
...
byte HT1635B::getYByteLocation_(byte y) {
